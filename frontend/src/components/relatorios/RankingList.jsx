    ...
    return (
        <Card>
            ...
            <CardContent className="flex flex-col gap-3">
                {itens.length === 0 && <p className="text-sm text-slate-500 dark:text-slate-400">Sem dados suficientes ainda.</p>}
                {itens.map((item, indice) => (
                    <div key={item.equipamento.id} className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400">{item.equipamento.marca} {item.equipamento.modelo}</p>
                        </div>

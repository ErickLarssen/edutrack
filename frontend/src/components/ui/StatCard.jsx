...
const TONES = {
    brand: {
        ...
        glow: 'from-brand-400/25 dark:from-brand-500/40',
        ring: 'dark:ring-brand-500/25',
        shadow: 'dark:shadow-brand-500/20',
        linha: 'text-brand-500/0 dark:text-brand-400/50',
    },
    success: {
...
export function StatCard({ label, value, icon: Icon, tone = 'brand' }) {
    ...
    return (
        <Card className={cn('relative overflow-hidden p-5 transition-shadow dark:shadow-lg dark:ring-1', tons.ring, tons.shadow)}>
            <div className={cn('pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br to-transparent blur-2xl', tons.glow)} />

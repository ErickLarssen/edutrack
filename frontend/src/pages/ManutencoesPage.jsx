    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Manutenção</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Ocorrências e reparos de equipamentos</p>
                </div>
